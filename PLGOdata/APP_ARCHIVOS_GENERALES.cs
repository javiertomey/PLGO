...
namespace PLGOdata
{
    ...
    public partial class APP_ARCHIVOS_GENERALES
    {
        public int ID { get; set; }
        public byte[] MANUAL_USUARIO { get; set; }
        public string NOMBRE_MANUAL_USUARIO { get; set; }
        public byte[] MANUAL_ADMIN { get; set; }
        public string NOMBRE_MANUAL_ADMIN { get; set; }
    }
}
