...
namespace PLGOdata
{
    ...
    public partial class ESTADOS_SEGUIMIENTO
    {
        ...
        public ESTADOS_SEGUIMIENTO()
        {
            this.ACCION = new HashSet<ACCION>();
            this.ACCION_PDTE_VAL = new HashSet<ACCION>();
        }
    
        public int ESTADO_SEGUIMIENTO_ID { get; set; }
        public string DESCRIPCION { get; set; }
    
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2227:CollectionPropertiesShouldBeReadOnly")]
        public virtual ICollection<ACCION> ACCION { get; set; }
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2227:CollectionPropertiesShouldBeReadOnly")]
        public virtual ICollection<ACCION> ACCION_PDTE_VAL { get; set; }
    }
}
