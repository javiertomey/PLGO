...
namespace PLGOdata
{
    [MetadataType(typeof(TIPO_CAMBIO_CONTENIDO_Validation))]
    public partial class TIPO_CAMBIO_CONTENIDO
    {
        public const int SIN_CAMBIOS = 0;
        public const int ALTA = 1;
        public const int MODIFICACION = 2;
        public const int ELIMINADO = 3;
    }

    public class TIPO_CAMBIO_CONTENIDO_Validation
    {
        [JsonIgnore]
